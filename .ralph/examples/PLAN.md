...
- [x] 1.11 Scenario 6: Conditional delete with `ConditionalCheckFailedException` handling (Spec 01 §Scenario 6)
  ...
  - Console output matches expected format from Spec 01
- [x] 1.12 Scenario 7: Direct result mapping — anonymous type (Spec 01 §Scenario 7)
...
- [x] 2.4 Create `docker-compose.yml` with DynamoDB Local + API container (Spec 02 §Infrastructure)
